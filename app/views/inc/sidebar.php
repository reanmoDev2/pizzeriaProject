<nav class="navbar navbar-expand-md bg-primary fixed-left">
  ...
  <div id="navbarContent">
    <ul class="nav navbar-nav">
      ...
      <li class="nav-item">
        <a href="<?php echo URLROOT; ?>/pages/menu" class="nav-link">
      ...
      <li class="nav-item">
        <a href="<?php echo URLROOT; ?>/pages/orders" class="nav-link">
      ...
      <li class="nav-item">
        <a href="<?php echo URLROOT; ?>/pages/settings" class="nav-link">
