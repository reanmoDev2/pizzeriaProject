<nav class="navbar navbar-expand-md bg-primary fixed-left">
  ...
  <div id="navbarContent">
    <ul class="nav navbar-nav">
      <li class="nav-item">
        <a href="<?php echo URLROOT; ?>/dashboards/index" class="nav-link <?php if ($data['activeSide'] == 'dashboard') echo ('active'); ?>">
      ...
      <li class="nav-item">
        <a href="<?php echo URLROOT; ?>/orders/index" class="nav-link <?php if ($data['activeSide'] == 'orders') echo ('active'); ?>">
      ...
      <li class="nav-item">
        <a href="<?php echo URLROOT; ?>/settings/index" class="nav-link <?php if ($data['activeSide'] == 'settings') echo ('active'); ?>">
