...
<div class="content-container">
  ...
  <form id="myform" action="<?php echo URLROOT; ?>/menus/create" method="post" enctype="multipart/form-data" runat="server">
    <div class="row">
      <div class="form-group col picture-container">
        ...
        <div class="form-group col d-flex">
          ...
          <img class="previewImg" src="#" alt="" id="previewImg">
    ...
    <div class="row">
      <div class="form-group col">
        ...
        <select name="mealCategory" class="form-control <?php echo (!empty($data['course_err'])) ? 'is-invalid' : ''; ?>" id="mealCategory">
          <option value="<?php echo ($data['course'] == '') ? '' : $data['course']; ?>"><?php echo ($data['course'] == '') ? 'Auswahl treffen...' : $data['course']; ?></option>
      ...
      <div class="form-group col">
        ...
        <input type="number" step="0.01" class="form-control" name="price1" value="<?php echo $data['price_small']; ?>">
      </div>
    </div>
    <div class="row">
      <div class="form-group col">
        <label for="price2">Preis Kategorie 2 (medium)</label>
        <input type="number" step="0.01" class="form-control" name="price2" value="<?php echo $data['price_medium']; ?>">
      </div>
      <div class="form-group col">
        <label for="price3">Preis Kategorie 3 (groß)</label>
        <input type="number" step="0.01" class="form-control" name="price3" value="<?php echo $data['price_large']; ?>">
      </div>
    </div>
    <div class="row">
      <div class="form-group col">
        <label for="comment">Bemerkung</label>
        <textarea name="comment" id="comment" cols="30" rows="10" class="form-control"><?php echo $data['description']; ?></textarea>
      </div>
    </div>
  </form>
