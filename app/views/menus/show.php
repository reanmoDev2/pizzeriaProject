...
<div class="content-container">
  <div class="header-container">
    ...
    <h2>Pizza Margherita Gouda</h2>
    <div class="btn-container">
      <a href="#" id="save" class="btn btn-dark mr-4">SPEICHERN</a>
  ...
  <form action="">
    ...
    <div class="row">
      <div class="form-group col">
        ...
        <input type="text" class="form-control" id="name" value="Pizza Margherita Gouda">
      </div>
    </div>
    <div class="row">
      <div class="form-group col">
        <label for="text">Gericht Art</label>
        <select name="mealCategory" class="form-control" id="mealCategory">
          <option value="">Hautspeise</option>
          <option value="">Sonstiges</option>
        </select>
      </div>
      <div class="form-group col">
        <label for="text">Preis Kategorie 1</label>
        <input type="text" class="form-control" id="price1" value="8,40€">
      </div>
    </div>
    <div class="row">
      <div class="form-group col">
        <label for="text">Preis Kategorie 2 (medium)</label>
        <input type="text" class="form-control" id="price2" value="10,50€">
      </div>
      <div class="form-group col">
        <label for="text">Preis Kategorie 3 (groß)</label>
        <input type="text" class="form-control" id="price3" value="16,30€">
      </div>
    </div>
    <div class="row">
      <div class="form-group col">
        <label for="text">Bemerkung</label>
        <textarea name="comment" id="comment" cols="30" rows="10" class="form-control">Zutaten: Käse und Tomaten :-)</textarea>
      </div>
    </div>
  </form>
